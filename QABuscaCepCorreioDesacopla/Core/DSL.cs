...
public class DSL
{
    ...
    public static void EscreveTexto(string elemento, string valor, [Optional] string descricao)
    {
        ...
        catch (Exception ex)
        {
            if (descricao != null)
            {
                ...
                logWriter.LogWrite("Erro ao preencher " + descricao + globalVariables.exceptionMsg + ex.Message);
            }

            Assert.Fail(); //se chegou aqui o teste falhou e vai pegar o erro com NUnit, o AssertFail mata a execução do teste, depois nada é executado.
        }
    }
    ...
    public static void ClicaElemento(string elemento, [Optional] string descricao)
    {
        ...
        catch (Exception ex)
        {
            if (descricao != null)
            {
                ...
                logWriter.LogWrite("Erro ao clicar no elemento " + descricao + globalVariables.exceptionMsg + ex.Message);
            }
    ...
    public static void ValidaDados(string elemento, string valor, [Optional] string descricao)
    {
        ...
        catch (Exception ex)
        {
            if (descricao != null)
            {
                ...
                logWriter.LogWrite("Erro ao validar elemento" + descricao + globalVariables.exceptionMsg + ex.Message);
            }
    ...
    public static void MenuDropDown(string elemento, string valor, [Optional] string descricao)
    {
        ...
        catch (Exception ex)
        {
            if (descricao != null)
            {
                ...
                logWriter.LogWrite("Erro ao selecionar opção no Dropdown: " + descricao + globalVariables.exceptionMsg + ex.Message);
            }
    ...
    public static string GeraNomeAleatorio()
    {
        ...
        return nome[random.Next(nome.Length)] + " " + sobrenome[random.Next(sobrenome.Length)];
    }
    ...
    public static string GeraEmailAleatorio()
    {
        ...
        var email = nome[random.Next(nome.Length)] + "." + sobrenome[random.Next(sobrenome.Length)] + dominio[random.Next(dominio.Length)];
